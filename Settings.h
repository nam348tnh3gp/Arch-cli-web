...
// Uncomment to enable a 16x2 LCD screen on I2C bus to display mining info in real time
// Default connections:
// GND - GND
// VCC - 5V (VIN/VU pin)
...
extern unsigned int ping = 0;
  ...
  DHT extern dht(DHTPIN, DHTTYPE);
    ...
    #include <Wire.h>
    // Cài đặt thư viện "LiquidCrystal I2C" của Frank de Brabander nếu bị lỗi
    // Vào Tools > Manage Libraries, tìm "LiquidCrystal I2C"
    #include <LiquidCrystal_I2C.h>

    // Khởi tạo màn hình LCD I2C với địa chỉ, số cột, số hàng
    // ⚠️ THAY 0x27 BẰNG ĐỊA CHỈ THỰC TẾ CỦA MÀN HÌNH BẠN (thường là 0x27 hoặc 0x3F)
